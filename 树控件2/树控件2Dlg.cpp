...
C树控件2Dlg::C树控件2Dlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(C树控件2Dlg::IDD, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void C树控件2Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
	DDX_Control(pDX, IDC_TREE1, m_tree);
}

BEGIN_MESSAGE_MAP(C树控件2Dlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_NOTIFY(TVN_SELCHANGED, IDC_TREE1, &C树控件2Dlg::OnTvnSelchangedTree1)
END_MESSAGE_MAP()


// C树控件2Dlg 消息处理程序

BOOL C树控件2Dlg::OnInitDialog()
{
...
void C树控件2Dlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//显示。
HCURSOR C树控件2Dlg::OnQueryDragIcon()
{
...
void C树控件2Dlg::OnTvnSelchangedTree1(NMHDR *pNMHDR, LRESULT *pResult)
{
